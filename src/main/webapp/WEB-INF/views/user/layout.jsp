					...
					<ul class="nav navbar-nav navbar-right">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<li><a href="account/logoff.php".php"> Đăng xuất</a></li>
							</c:otherwise>
						</c:choose>
					</ul>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center bottom-separator">
					<img src="resources/images/home/under.png"
			...
			<div class="modal-content">
				<form action="account/login.php" method="post">
					<div class="modal-header" id="loginform">
						...
						<h2 class="modal-title text-center" style="padding-bottom: 11px">Đăng
							nhập</h2>
					</div>
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-sm-5">
								<img src="resources/images/home/clients.png"
									class="slider-cycle" alt="" style="padding-left: 50px;">
							</div>
							<div class="col-sm-7">

								<div class="form-group">
									<input type="text" class="form-control" id="inputEmail"
										placeholder="Tên đăng nhập" name="id">

								</div>
								<div class="form-group">
									<input type="password" class="form-control" id="inputPassword"
										placeholder="Mật khẩu" name="pw">
								</div>
								<div class="form-group">
